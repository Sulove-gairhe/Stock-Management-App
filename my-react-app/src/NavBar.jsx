      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="relative w-full max-w-lg">
          <input
            ...
            className="w-full h-12 pl-4 pr-12 rounded-full border border-gray-300 focus:outline-none focus:border-slate-800 transition duration-300"
...
//for color change of border and icon when user clicks in the input field
          ...
          <FontAwesomeIcon
            icon={faSearch}
            className={`absolute right-4 top-4 transition-colors duration-300 ${isFocused? 'text-slate-800' : 'text-gray-500'}`}
          />
        </div>
      </div>
    </div>
